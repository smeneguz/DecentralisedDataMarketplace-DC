...
/**
 * @route POST /api/purchaseLicenseUsage
 * @description User purchases a license "usage" (ERC20 datatoken) associated to a specific NFT (dataset or service - ERC721 contract)
 ...
 * @param {number} req.body.usage - The amount of licenses you want to buy (consider every time you use it the counter decrease by one)
...
export default async function handler(req: NextApiRequest, res: NextApiResponse){
    ...
    form.parse(req, async (err: any, fields: any) => {
        ...
        try{
            ...
            const amount: number = parseInt(fields["usage"] as string)
            ...
            await chainObj.factory721.methods.buyNFTlicenseUsage(fields["nftAddress"], fields["licenseAddress"], amount)
