import { Row, Container, Button, Table, Tooltip, OverlayTrigger } from "react-bootstrap";
import "../App.css";
        ...
        <Table responsive striped bordered hover className="table-border" >
          ...
          <tbody>
            {licenses.length > 0 ? (
              ...
              <tr>
                <td className=" text-center" colSpan="8">You have no Licenses for this dataset.</td>
              </tr>
            )}
          </tbody>
        </Table>
