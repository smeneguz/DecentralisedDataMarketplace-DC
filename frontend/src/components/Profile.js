    ...
    <Container fluid className="mt-4 pt-5 profile ">
      <Row>
        <Col md={2} className="profile-sidebar">
          ...
          <Row className="side-bar-button">
            <h6 className={`side-bar-text${props.profilePage === 3 ? '-active' : ''}`} onClick={() => { props.setNftAddress(""); props.setProfilePage(3); }}> Datasets and Licenses </h6>
          </Row>
          <Row className="side-bar-button">
            <h6 className={`side-bar-text${props.profilePage === 4 ? '-active' : ''}`} onClick={() => props.setProfilePage(4)}> Create New Ones </h6>
          </Row>
          <Row className="side-bar-button">
            <h6 className={`side-bar-text${props.profilePage === 7 ? '-active' : ''}`} onClick={() => { props.setNftAddress(""); props.setProfilePage(5) }}> Purchased Licenses </h6>
          </Row>
          <Row className="side-bar-button">
        ...
        <Col md={10} >
          ...
          {(props.profilePage === 5) && <ProfilePurchasedDataset setMessage={props.setMessage} nftAddress={props.nftAddress} setNftAddress={props.setNftAddress} />}
